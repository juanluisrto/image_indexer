 ...
 * Note that you have to run it with giving the OpenCV library path, eg. "-D java.library.path="lib\opencv"
...
public class IndexingAndSearchWithLocalFeatures {
    ...
    public static void search(String indexPath) throws IOException {
        ...
        ImageSearchHits hits = imgSearcher.search(ImageIO.read(new File("img_to_search/test.jpg")), reader);
